...
<span data-ttu-id="dffd3-112">Le versioni di MSL sono differenziate in base agli spazi dei nomi XML.</span><span class="sxs-lookup"><span data-stu-id="dffd3-112">Versions of MSL are differentiated by XML namespaces.</span></span>
...
<span data-ttu-id="dffd3-137">Nell'esempio seguente viene illustrato un elemento **alias** che definisce un alias, `c` , per i tipi definiti nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-137">The following example shows an **Alias** element that defines an alias, `c`, for types that are defined in the conceptual model.</span></span>
...
<span data-ttu-id="dffd3-163">Si consideri inoltre la seguente stored procedure:</span><span class="sxs-lookup"><span data-stu-id="dffd3-163">Also consider the following stored procedure:</span></span>
...
<span data-ttu-id="dffd3-177">L'elemento **AssociationSetMapping** può avere gli elementi figlio seguenti</span><span class="sxs-lookup"><span data-stu-id="dffd3-177">The **AssociationSetMapping** element can have the following child elements</span></span>
...
## <a name="complexproperty-element-msl"></a><span data-ttu-id="dffd3-199">Elemento ComplexProperty (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-199">ComplexProperty Element (MSL)</span></span>
...
<span data-ttu-id="dffd3-224">L'elemento **ComplexTypeMapping** in Mapping Specification Language (MSL) è un elemento figlio dell'elemento ResultMapping e definisce il mapping tra un'importazione di funzioni nel modello concettuale e una stored procedure nel database sottostante quando sono soddisfatte le condizioni seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-224">The **ComplexTypeMapping** element in mapping specification language (MSL) is a child of the ResultMapping element and defines the mapping between a function import in the conceptual model and a stored procedure in the underlying database when the following are true:</span></span>
...
<span data-ttu-id="dffd3-241">Si consideri la stored procedure seguente:</span><span class="sxs-lookup"><span data-stu-id="dffd3-241">Consider the following stored procedure:</span></span>
...
<span data-ttu-id="dffd3-260">L'elemento **Condition** non può avere elementi figlio.</span><span class="sxs-lookup"><span data-stu-id="dffd3-260">The **Condition** element can have no child elements.</span></span>
...
### <a name="example"></a><span data-ttu-id="dffd3-285">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-285">Example</span></span>
...
| <span data-ttu-id="dffd3-302">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-302">Attribute Name</span></span>            | <span data-ttu-id="dffd3-303">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-303">Is Required</span></span> | <span data-ttu-id="dffd3-304">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-304">Value</span></span>                                                                                                                                                    |
|:--------------------------|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
...
### <a name="deletefunction-applied-to-associationsetmapping"></a><span data-ttu-id="dffd3-315">DeleteFunction applicato ad AssociationSetMapping</span><span class="sxs-lookup"><span data-stu-id="dffd3-315">DeleteFunction Applied to AssociationSetMapping</span></span>
...
<span data-ttu-id="dffd3-342">Nella tabella seguente vengono descritti gli attributi applicabili all'elemento **EndProperty** :</span><span class="sxs-lookup"><span data-stu-id="dffd3-342">The following table describes the attributes that are applicable to the **EndProperty** element:</span></span>
...
| <span data-ttu-id="dffd3-402">**StoreEntitySet** **1**</span><span class="sxs-lookup"><span data-stu-id="dffd3-402">**StoreEntitySet** **1**</span></span> | <span data-ttu-id="dffd3-403">No</span><span class="sxs-lookup"><span data-stu-id="dffd3-403">No</span></span>          | <span data-ttu-id="dffd3-404">Nome del set di entità del modello di archiviazione a cui viene eseguito il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-404">The name of the storage model entity set that is being mapped to.</span></span>                                                                                                                                                             |
...
## <a name="entitytypemapping-element-msl"></a><span data-ttu-id="dffd3-413">Elemento EntityTypeMapping (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-413">EntityTypeMapping Element (MSL)</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-426">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-426">Applicable Attributes</span></span>
...
### <a name="example"></a><span data-ttu-id="dffd3-439">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-439">Example</span></span>
...
## <a name="functionimportmapping-element-msl"></a><span data-ttu-id="dffd3-442">Elemento FunctionImportMapping (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-442">FunctionImportMapping Element (MSL)</span></span>

<span data-ttu-id="dffd3-443">L'elemento **FunctionImportMapping** in Mapping Specification Language (MSL) definisce il mapping tra un'importazione di funzioni nel modello concettuale e una stored procedure o una funzione nel database sottostante.</span><span class="sxs-lookup"><span data-stu-id="dffd3-443">The **FunctionImportMapping** element in mapping specification language (MSL) defines the mapping between a function import in the conceptual model and a stored procedure or function in the underlying database.</span></span> <span data-ttu-id="dffd3-444">Le importazioni di funzioni devono essere dichiarate nel modello concettuale mentre le stored procedure nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-444">Function imports must be declared in the conceptual model and stored procedures must be declared in the storage model.</span></span> <span data-ttu-id="dffd3-445">Per ulteriori informazioni, vedere elemento FunctionImport (CSDL) e elemento Function (SSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-445">For more information, see FunctionImport Element (CSDL) and Function Element (SSDL).</span></span>

> [!NOTE]
> <span data-ttu-id="dffd3-446">Per impostazione predefinita, se un'importazione di funzioni restituisce un tipo di entità del modello concettuale o un tipo complesso, i nomi delle colonne restituiti dalla stored procedure sottostante devono corrispondere esattamente ai nomi delle proprietà nel tipo di modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-446">By default, if a function import returns a conceptual model entity type or complex type, then the names of the columns returned by the underlying stored procedure must exactly match the names of the properties on the conceptual model type.</span></span> <span data-ttu-id="dffd3-447">Se i nomi delle colonne non corrispondono esattamente ai nomi delle proprietà, il mapping deve essere definito in un elemento ResultMapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-447">If the column names do not exactly match the property names, the mapping must be defined in a ResultMapping element.</span></span>

<span data-ttu-id="dffd3-448">L'elemento **FunctionImportMapping** può avere gli elementi figlio seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-448">The **FunctionImportMapping** element can have the following child elements:</span></span>

-   <span data-ttu-id="dffd3-449">ResultMapping (zero o più)</span><span class="sxs-lookup"><span data-stu-id="dffd3-449">ResultMapping (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-450">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-450">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-451">Nella tabella seguente vengono descritti gli attributi applicabili all'elemento **FunctionImportMapping** :</span><span class="sxs-lookup"><span data-stu-id="dffd3-451">The following table describes the attributes that are applicable to the **FunctionImportMapping** element:</span></span>

| <span data-ttu-id="dffd3-452">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-452">Attribute Name</span></span>         | <span data-ttu-id="dffd3-453">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-453">Is Required</span></span> | <span data-ttu-id="dffd3-454">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-454">Value</span></span>                                                                                   |
|:-----------------------|:------------|:----------------------------------------------------------------------------------------|
| <span data-ttu-id="dffd3-455">**FunctionImportName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-455">**FunctionImportName**</span></span> | <span data-ttu-id="dffd3-456">Yes</span><span class="sxs-lookup"><span data-stu-id="dffd3-456">Yes</span></span>         | <span data-ttu-id="dffd3-457">Nome dell'importazione di funzioni nel modello concettuale di cui è in corso il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-457">The name of the function import in the conceptual model that is being mapped.</span></span>           |
| <span data-ttu-id="dffd3-458">**FunctionName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-458">**FunctionName**</span></span>       | <span data-ttu-id="dffd3-459">Sì</span><span class="sxs-lookup"><span data-stu-id="dffd3-459">Yes</span></span>         | <span data-ttu-id="dffd3-460">Nome completo dello spazio dei nomi della funzione nel modello di archiviazione di cui è in corso il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-460">The namespace-qualified name of the function in the storage model that is being mapped.</span></span> |

### <a name="example"></a><span data-ttu-id="dffd3-461">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-461">Example</span></span>

<span data-ttu-id="dffd3-462">Di seguito viene riportato un esempio basato sul modello School.</span><span class="sxs-lookup"><span data-stu-id="dffd3-462">The following example is based on the School model.</span></span> <span data-ttu-id="dffd3-463">Si consideri la funzione seguente nel modello di archiviazione:</span><span class="sxs-lookup"><span data-stu-id="dffd3-463">Consider the following function in the storage model:</span></span>
...
<span data-ttu-id="dffd3-464">Si consideri anche questa importazione di funzioni nel modello concettuale:</span><span class="sxs-lookup"><span data-stu-id="dffd3-464">Also consider this function import in the conceptual model:</span></span>
...
```
 
## <a name="insertfunction-element-msl"></a><span data-ttu-id="dffd3-466">Elemento InsertFunction (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-466">InsertFunction Element (MSL)</span></span>

<span data-ttu-id="dffd3-467">L'elemento **InsertFunction** in Mapping Specification Language (MSL) esegue il mapping della funzione di inserimento di un tipo di entità o di un'associazione nel modello concettuale a una stored procedure nel database sottostante.</span><span class="sxs-lookup"><span data-stu-id="dffd3-467">The **InsertFunction** element in mapping specification language (MSL) maps the insert function of an entity type or association in the conceptual model to a stored procedure in the underlying database.</span></span> <span data-ttu-id="dffd3-468">Le stored procedure a cui le funzioni di modifica sono mappate devono essere dichiarate nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-468">Stored procedures to which modification functions are mapped must be declared in the storage model.</span></span> <span data-ttu-id="dffd3-469">Per ulteriori informazioni, vedere elemento Function (SSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-469">For more information, see Function Element (SSDL).</span></span>

> [!NOTE]
> <span data-ttu-id="dffd3-470">Se non si esegue il mapping di tutte e tre le operazioni di inserimento, aggiornamento o eliminazione di un tipo di entità alle stored procedure, le operazioni non mappate avranno esito negativo se eseguite in fase di esecuzione e viene generata un'eccezione UpdateException.</span><span class="sxs-lookup"><span data-stu-id="dffd3-470">If you do not map all three of the insert, update, or delete operations of a entity type to stored procedures, the unmapped operations will fail if executed at runtime and an UpdateException is thrown.</span></span>

<span data-ttu-id="dffd3-471">L'elemento **InsertFunction** può essere un elemento figlio dell'elemento ModificationFunctionMapping e applicato all'elemento EntityTypeMapping o AssociationSetMapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-471">The **InsertFunction** element can be a child of the ModificationFunctionMapping element and applied to the EntityTypeMapping element or the AssociationSetMapping element.</span></span>

### <a name="insertfunction-applied-to-entitytypemapping"></a><span data-ttu-id="dffd3-472">InsertFunction applicato a EntityTypeMapping</span><span class="sxs-lookup"><span data-stu-id="dffd3-472">InsertFunction Applied to EntityTypeMapping</span></span>

<span data-ttu-id="dffd3-473">Quando applicato all'elemento EntityTypeMapping, l'elemento **InsertFunction** esegue il mapping della funzione di inserimento di un tipo di entità nel modello concettuale a un stored procedure.</span><span class="sxs-lookup"><span data-stu-id="dffd3-473">When applied to the EntityTypeMapping element, the **InsertFunction** element maps the insert function of an entity type in the conceptual model to a stored procedure.</span></span>

<span data-ttu-id="dffd3-474">Quando viene applicato a un elemento **EntityTypeMapping** , l'elemento **InsertFunction** può includere i seguenti elementi figlio:</span><span class="sxs-lookup"><span data-stu-id="dffd3-474">The **InsertFunction** element can have the following child elements when applied to an **EntityTypeMapping** element:</span></span>

-   <span data-ttu-id="dffd3-475">AssociationEnd (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-475">AssociationEnd (zero or more)</span></span>
-   <span data-ttu-id="dffd3-476">ComplexProperty (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-476">ComplexProperty (zero or more)</span></span>
-   <span data-ttu-id="dffd3-477">ResultBinding (zero o un elemento)</span><span class="sxs-lookup"><span data-stu-id="dffd3-477">ResultBinding (zero or one)</span></span>
-   <span data-ttu-id="dffd3-478">ScarlarProperty (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-478">ScarlarProperty (zero or more)</span></span>

#### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-479">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-479">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-480">Nella tabella seguente vengono descritti gli attributi che possono essere applicati all'elemento **InsertFunction** quando vengono applicati a un elemento **EntityTypeMapping** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-480">The following table describes the attributes that can be applied to the **InsertFunction** element when applied to an **EntityTypeMapping** element.</span></span>

| <span data-ttu-id="dffd3-481">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-481">Attribute Name</span></span>            | <span data-ttu-id="dffd3-482">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-482">Is Required</span></span> | <span data-ttu-id="dffd3-483">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-483">Value</span></span>                                                                                                                                                    |
|:--------------------------|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="dffd3-484">**FunctionName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-484">**FunctionName**</span></span>          | <span data-ttu-id="dffd3-485">Sì</span><span class="sxs-lookup"><span data-stu-id="dffd3-485">Yes</span></span>         | <span data-ttu-id="dffd3-486">Nome completo dello spazio dei nomi della stored procedure a cui la funzione di inserimento viene mappata.</span><span class="sxs-lookup"><span data-stu-id="dffd3-486">The namespace-qualified name of the stored procedure to which the insert function is mapped.</span></span> <span data-ttu-id="dffd3-487">La stored procedure deve essere dichiarata nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-487">The stored procedure must be declared in the storage model.</span></span> |
| <span data-ttu-id="dffd3-488">**RowsAffectedParameter**</span><span class="sxs-lookup"><span data-stu-id="dffd3-488">**RowsAffectedParameter**</span></span> | <span data-ttu-id="dffd3-489">No</span><span class="sxs-lookup"><span data-stu-id="dffd3-489">No</span></span>          | <span data-ttu-id="dffd3-490">Nome del parametro di output che restituisce il numero di righe interessate.</span><span class="sxs-lookup"><span data-stu-id="dffd3-490">The name of the output parameter that returns the number of affected rows.</span></span>                                                                               |

#### <a name="example"></a><span data-ttu-id="dffd3-491">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-491">Example</span></span>

<span data-ttu-id="dffd3-492">L'esempio seguente è basato sul modello School e Mostra l'elemento **InsertFunction** usato per eseguire il mapping della funzione di inserimento del tipo di entità Person alla stored procedure **InsertPerson** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-492">The following example is based on the School model and shows the **InsertFunction** element used to map insert function of the Person entity type to the **InsertPerson** stored procedure.</span></span> <span data-ttu-id="dffd3-493">Il stored procedure **InsertPerson** viene dichiarato nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-493">The **InsertPerson** stored procedure is declared in the storage model.</span></span>
...
```
### <a name="insertfunction-applied-to-associationsetmapping"></a><span data-ttu-id="dffd3-494">InsertFunction applicato ad AssociationSetMapping</span><span class="sxs-lookup"><span data-stu-id="dffd3-494">InsertFunction Applied to AssociationSetMapping</span></span>

<span data-ttu-id="dffd3-495">Quando applicato all'elemento AssociationSetMapping, l'elemento **InsertFunction** esegue il mapping della funzione di inserimento di un'associazione nel modello concettuale a un stored procedure.</span><span class="sxs-lookup"><span data-stu-id="dffd3-495">When applied to the AssociationSetMapping element, the **InsertFunction** element maps the insert function of an association in the conceptual model to a stored procedure.</span></span>

<span data-ttu-id="dffd3-496">L'elemento **InsertFunction** può avere gli elementi figlio seguenti quando viene applicato all'elemento **AssociationSetMapping** :</span><span class="sxs-lookup"><span data-stu-id="dffd3-496">The **InsertFunction** element can have the following child elements when applied to the **AssociationSetMapping** element:</span></span>

-   <span data-ttu-id="dffd3-497">EndProperty</span><span class="sxs-lookup"><span data-stu-id="dffd3-497">EndProperty</span></span>

#### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-498">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-498">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-499">Nella tabella seguente vengono descritti gli attributi che è possibile applicare all'elemento **InsertFunction** quando viene applicato all'elemento **AssociationSetMapping** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-499">The following table describes the attributes that can be applied to the **InsertFunction** element when it is applied to the **AssociationSetMapping** element.</span></span>

| <span data-ttu-id="dffd3-500">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-500">Attribute Name</span></span>            | <span data-ttu-id="dffd3-501">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-501">Is Required</span></span> | <span data-ttu-id="dffd3-502">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-502">Value</span></span>                                                                                                                                                    |
|:--------------------------|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="dffd3-503">**FunctionName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-503">**FunctionName**</span></span>          | <span data-ttu-id="dffd3-504">Sì</span><span class="sxs-lookup"><span data-stu-id="dffd3-504">Yes</span></span>         | <span data-ttu-id="dffd3-505">Nome completo dello spazio dei nomi della stored procedure a cui la funzione di inserimento viene mappata.</span><span class="sxs-lookup"><span data-stu-id="dffd3-505">The namespace-qualified name of the stored procedure to which the insert function is mapped.</span></span> <span data-ttu-id="dffd3-506">La stored procedure deve essere dichiarata nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-506">The stored procedure must be declared in the storage model.</span></span> |
| <span data-ttu-id="dffd3-507">**RowsAffectedParameter**</span><span class="sxs-lookup"><span data-stu-id="dffd3-507">**RowsAffectedParameter**</span></span> | <span data-ttu-id="dffd3-508">No</span><span class="sxs-lookup"><span data-stu-id="dffd3-508">No</span></span>          | <span data-ttu-id="dffd3-509">Nome del parametro di output che restituisce il numero di righe interessate.</span><span class="sxs-lookup"><span data-stu-id="dffd3-509">The name of the output parameter that returns the number of rows affected.</span></span>                                                                               |

#### <a name="example"></a><span data-ttu-id="dffd3-510">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-510">Example</span></span>

<span data-ttu-id="dffd3-511">L'esempio seguente è basato sul modello School e Mostra l'elemento **InsertFunction** usato per eseguire il mapping della funzione di inserimento dell'associazione **CourseInstructor** a **InsertCourseInstructor** stored procedure.</span><span class="sxs-lookup"><span data-stu-id="dffd3-511">The following example is based on the School model and shows the **InsertFunction** element used to map insert function of the **CourseInstructor** association to the **InsertCourseInstructor** stored procedure.</span></span> <span data-ttu-id="dffd3-512">Il stored procedure **InsertCourseInstructor** viene dichiarato nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-512">The **InsertCourseInstructor** stored procedure is declared in the storage model.</span></span>
...
## <a name="mapping-element-msl"></a><span data-ttu-id="dffd3-513">Elemento Mapping (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-513">Mapping Element (MSL)</span></span>

<span data-ttu-id="dffd3-514">L'elemento **mapping** in Mapping Specification Language (MSL) contiene informazioni per il mapping di oggetti definiti in un modello concettuale a un database (come descritto in un modello di archiviazione).</span><span class="sxs-lookup"><span data-stu-id="dffd3-514">The **Mapping** element in mapping specification language (MSL) contains information for mapping objects that are defined in a conceptual model to a database (as described in a storage model).</span></span> <span data-ttu-id="dffd3-515">Per ulteriori informazioni, vedere Specification CSDL e SSDL Specification.</span><span class="sxs-lookup"><span data-stu-id="dffd3-515">For more information, see CSDL Specification and SSDL Specification.</span></span>

<span data-ttu-id="dffd3-516">L'elemento **mapping** è l'elemento radice per una specifica di mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-516">The **Mapping** element is the root element for a mapping specification.</span></span> <span data-ttu-id="dffd3-517">Lo spazio dei nomi XML per le specifiche di mapping è https://schemas.microsoft.com/ado/2009/11/mapping/cs .</span><span class="sxs-lookup"><span data-stu-id="dffd3-517">The XML namespace for mapping specifications is https://schemas.microsoft.com/ado/2009/11/mapping/cs.</span></span>

<span data-ttu-id="dffd3-518">L'elemento Mapping può includere i seguenti elementi figlio (nell'ordine elencato):</span><span class="sxs-lookup"><span data-stu-id="dffd3-518">The mapping element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="dffd3-519">Alias (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-519">Alias (zero or more)</span></span>
-   <span data-ttu-id="dffd3-520">EntityContainerMapping (esattamente un elemento)</span><span class="sxs-lookup"><span data-stu-id="dffd3-520">EntityContainerMapping (exactly one)</span></span>

<span data-ttu-id="dffd3-521">I nomi di tipi di modelli concettuale e di archiviazione a cui viene fatto riferimento in MSL devono essere qualificati dai rispettivi nomi dello spazio dei nomi.</span><span class="sxs-lookup"><span data-stu-id="dffd3-521">Names of conceptual and storage model types that are referenced in MSL must be qualified by their respective namespace names.</span></span> <span data-ttu-id="dffd3-522">Per informazioni sul nome dello spazio dei nomi del modello concettuale, vedere elemento schema (CSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-522">For information about the conceptual model namespace name, see Schema Element (CSDL).</span></span> <span data-ttu-id="dffd3-523">Per informazioni sul nome dello spazio dei nomi del modello di archiviazione, vedere elemento schema (SSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-523">For information about the storage model namespace name, see Schema Element (SSDL).</span></span> <span data-ttu-id="dffd3-524">Gli alias per gli spazi dei nomi utilizzati in MSL possono essere definiti con l'elemento Alias.</span><span class="sxs-lookup"><span data-stu-id="dffd3-524">Aliases for namespaces that are used in MSL can be defined with the Alias element.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-525">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-525">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-526">Nella tabella seguente vengono descritti gli attributi che è possibile applicare all'elemento di **mapping** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-526">The table below describes the attributes that can be applied to the **Mapping** element.</span></span>

| <span data-ttu-id="dffd3-527">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-527">Attribute Name</span></span> | <span data-ttu-id="dffd3-528">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-528">Is Required</span></span> | <span data-ttu-id="dffd3-529">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-529">Value</span></span>                                                 |
|:---------------|:------------|:------------------------------------------------------|
| <span data-ttu-id="dffd3-530">**Spazio**</span><span class="sxs-lookup"><span data-stu-id="dffd3-530">**Space**</span></span>      | <span data-ttu-id="dffd3-531">Yes</span><span class="sxs-lookup"><span data-stu-id="dffd3-531">Yes</span></span>         | <span data-ttu-id="dffd3-532">**C-S**.</span><span class="sxs-lookup"><span data-stu-id="dffd3-532">**C-S**.</span></span> <span data-ttu-id="dffd3-533">Si tratta di un valore fisso e non può essere modificato.</span><span class="sxs-lookup"><span data-stu-id="dffd3-533">This is a fixed value and cannot be changed.</span></span> |

### <a name="example"></a><span data-ttu-id="dffd3-534">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-534">Example</span></span>

<span data-ttu-id="dffd3-535">Nell'esempio seguente viene illustrato un elemento di **mapping** basato su una parte del modello School.</span><span class="sxs-lookup"><span data-stu-id="dffd3-535">The following example shows a **Mapping** element that is based on part of the School model.</span></span> <span data-ttu-id="dffd3-536">Per ulteriori informazioni sul modello School, vedere Guida introduttiva (Entity Framework):</span><span class="sxs-lookup"><span data-stu-id="dffd3-536">For more information about the School model, see Quickstart (Entity Framework):</span></span>
...
## <a name="mappingfragment-element-msl"></a><span data-ttu-id="dffd3-537">Elemento MappingFragment (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-537">MappingFragment Element (MSL)</span></span>

<span data-ttu-id="dffd3-538">L'elemento **MappingFragment** in Mapping Specification Language (MSL) definisce il mapping tra le proprietà di un tipo di entità del modello concettuale e una tabella o una vista nel database.</span><span class="sxs-lookup"><span data-stu-id="dffd3-538">The **MappingFragment** element in mapping specification language (MSL) defines the mapping between the properties of a conceptual model entity type and a table or view in the database.</span></span> <span data-ttu-id="dffd3-539">Per informazioni sui tipi di entità del modello concettuale e sulle tabelle o visualizzazioni del database sottostante, vedere Elemento EntityType (CSDL) e Elemento EntitySet (SSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-539">For information about conceptual model entity types and underlying database tables or views, see EntityType Element (CSDL) and EntitySet Element (SSDL).</span></span> <span data-ttu-id="dffd3-540">**MappingFragment** può essere un elemento figlio dell'elemento EntityTypeMapping o EntitySetMapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-540">The **MappingFragment** can be a child element of the EntityTypeMapping element or the EntitySetMapping element.</span></span>

<span data-ttu-id="dffd3-541">L'elemento **MappingFragment** può avere gli elementi figlio seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-541">The **MappingFragment** element can have the following child elements:</span></span>

-   <span data-ttu-id="dffd3-542">ComplexType (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-542">ComplexType (zero or more)</span></span>
-   <span data-ttu-id="dffd3-543">ScalarProperty (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-543">ScalarProperty (zero or more)</span></span>
-   <span data-ttu-id="dffd3-544">Condition (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-544">Condition (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-545">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-545">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-546">Nella tabella seguente vengono descritti gli attributi che è possibile applicare all'elemento **MappingFragment** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-546">The following table describes the attributes that can be applied to the **MappingFragment** element.</span></span>

| <span data-ttu-id="dffd3-547">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-547">Attribute Name</span></span>          | <span data-ttu-id="dffd3-548">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-548">Is Required</span></span> | <span data-ttu-id="dffd3-549">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-549">Value</span></span>                                                                                                                                                                                                                         |
|:------------------------|:------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="dffd3-550">**StoreEntitySet**</span><span class="sxs-lookup"><span data-stu-id="dffd3-550">**StoreEntitySet**</span></span>      | <span data-ttu-id="dffd3-551">Yes</span><span class="sxs-lookup"><span data-stu-id="dffd3-551">Yes</span></span>         | <span data-ttu-id="dffd3-552">Nome della tabella o visualizzazione di cui è in corso il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-552">The name of the table or view that is being mapped.</span></span>                                                                                                                                                                           |
| <span data-ttu-id="dffd3-553">**Makecolumnsdistinct impostato**</span><span class="sxs-lookup"><span data-stu-id="dffd3-553">**MakeColumnsDistinct**</span></span> | <span data-ttu-id="dffd3-554">No</span><span class="sxs-lookup"><span data-stu-id="dffd3-554">No</span></span>          | <span data-ttu-id="dffd3-555">**True** o **false** , a seconda che vengano restituite solo righe distinte.</span><span class="sxs-lookup"><span data-stu-id="dffd3-555">**True** or **False** depending on whether only distinct rows are returned.</span></span> <br/> <span data-ttu-id="dffd3-556">Se questo attributo è impostato su **true**, l'attributo **GenerateUpdateViews** dell'elemento EntityContainerMapping deve essere impostato su **false**.</span><span class="sxs-lookup"><span data-stu-id="dffd3-556">If this attribute is set to **True**, the **GenerateUpdateViews** attribute of the EntityContainerMapping element must be set to **False**.</span></span> |

### <a name="example"></a><span data-ttu-id="dffd3-557">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-557">Example</span></span>

<span data-ttu-id="dffd3-558">Nell'esempio seguente viene illustrato un elemento **MappingFragment** come figlio di un elemento **EntityTypeMapping** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-558">The following example shows a **MappingFragment** element as the child of an **EntityTypeMapping** element.</span></span> <span data-ttu-id="dffd3-559">In questo esempio, le proprietà del tipo **Course** nel modello concettuale vengono mappate alle colonne della tabella **Course** nel database.</span><span class="sxs-lookup"><span data-stu-id="dffd3-559">In this example, properties of the **Course** type in the conceptual model are mapped to columns of the **Course** table in the database.</span></span>
...
### <a name="example"></a><span data-ttu-id="dffd3-560">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-560">Example</span></span>

<span data-ttu-id="dffd3-561">Nell'esempio seguente viene illustrato un elemento **MappingFragment** come figlio di un elemento **EntitySetMapping** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-561">The following example shows a **MappingFragment** element as the child of an **EntitySetMapping** element.</span></span> <span data-ttu-id="dffd3-562">Come nell'esempio precedente, le proprietà del tipo **Course** nel modello concettuale vengono mappate alle colonne della tabella **Course** nel database.</span><span class="sxs-lookup"><span data-stu-id="dffd3-562">As in the example above, properties of the **Course** type in the conceptual model are mapped to columns of the **Course** table in the database.</span></span>
...
## <a name="modificationfunctionmapping-element-msl"></a><span data-ttu-id="dffd3-563">Elemento ModificationFunctionMapping (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-563">ModificationFunctionMapping Element (MSL)</span></span>

<span data-ttu-id="dffd3-564">L'elemento **ModificationFunctionMapping** in Mapping Specification Language (MSL) esegue il mapping delle funzioni di inserimento, aggiornamento ed eliminazione di un tipo di entità del modello concettuale alle stored procedure nel database sottostante.</span><span class="sxs-lookup"><span data-stu-id="dffd3-564">The **ModificationFunctionMapping** element in mapping specification language (MSL) maps the insert, update, and delete functions of a conceptual model entity type to stored procedures in the underlying database.</span></span> <span data-ttu-id="dffd3-565">L'elemento **ModificationFunctionMapping** può inoltre eseguire il mapping delle funzioni Insert e DELETE per le associazioni molti-a-molti nel modello concettuale alle stored procedure nel database sottostante.</span><span class="sxs-lookup"><span data-stu-id="dffd3-565">The **ModificationFunctionMapping** element can also map the insert and delete functions for many-to-many associations in the conceptual model to stored procedures in the underlying database.</span></span> <span data-ttu-id="dffd3-566">Le stored procedure a cui le funzioni di modifica sono mappate devono essere dichiarate nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-566">Stored procedures to which modification functions are mapped must be declared in the storage model.</span></span> <span data-ttu-id="dffd3-567">Per ulteriori informazioni, vedere elemento Function (SSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-567">For more information, see Function Element (SSDL).</span></span>

> [!NOTE]
> <span data-ttu-id="dffd3-568">Se non si esegue il mapping di tutte e tre le operazioni di inserimento, aggiornamento o eliminazione di un tipo di entità alle stored procedure, le operazioni non mappate avranno esito negativo se eseguite in fase di esecuzione e viene generata un'eccezione UpdateException.</span><span class="sxs-lookup"><span data-stu-id="dffd3-568">If you do not map all three of the insert, update, or delete operations of a entity type to stored procedures, the unmapped operations will fail if executed at runtime and an UpdateException is thrown.</span></span>


> [!NOTE]
> <span data-ttu-id="dffd3-569">Se esiste un mapping tra le funzioni di modifica per un'entità in una gerarchia di ereditarietà e stored procedure, è necessario eseguire il mapping delle funzioni di modifica per tutti i tipi nella gerarchia a stored procedure.</span><span class="sxs-lookup"><span data-stu-id="dffd3-569">If the modification functions for one entity in an inheritance hierarchy are mapped to stored procedures, then modification functions for all types in the hierarchy must be mapped to stored procedures.</span></span>

<span data-ttu-id="dffd3-570">L'elemento **ModificationFunctionMapping** può essere un elemento figlio dell'elemento EntityTypeMapping o AssociationSetMapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-570">The **ModificationFunctionMapping** element can be a child of the EntityTypeMapping element or the AssociationSetMapping element.</span></span>

<span data-ttu-id="dffd3-571">L'elemento **ModificationFunctionMapping** può avere gli elementi figlio seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-571">The **ModificationFunctionMapping** element can have the following child elements:</span></span>

-   <span data-ttu-id="dffd3-572">DeleteFunction (zero o un elemento)</span><span class="sxs-lookup"><span data-stu-id="dffd3-572">DeleteFunction (zero or one)</span></span>
-   <span data-ttu-id="dffd3-573">InsertFunction (zero o un elemento)</span><span class="sxs-lookup"><span data-stu-id="dffd3-573">InsertFunction (zero or one)</span></span>
-   <span data-ttu-id="dffd3-574">UpdateFunction (zero o un elemento)</span><span class="sxs-lookup"><span data-stu-id="dffd3-574">UpdateFunction (zero or one)</span></span>

<span data-ttu-id="dffd3-575">Nessun attributo applicabile all'elemento **ModificationFunctionMapping** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-575">No attributes are applicable to the **ModificationFunctionMapping** element.</span></span>

### <a name="example"></a><span data-ttu-id="dffd3-576">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-576">Example</span></span>

<span data-ttu-id="dffd3-577">Nell'esempio seguente viene illustrato il mapping del set di entità per il set di entità **people** nel modello School.</span><span class="sxs-lookup"><span data-stu-id="dffd3-577">The following example shows the entity set mapping for the **People** entity set in the School model.</span></span> <span data-ttu-id="dffd3-578">Oltre al mapping delle colonne per il tipo di entità **Person** , viene visualizzato il mapping delle funzioni di inserimento, aggiornamento ed eliminazione del tipo **Person** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-578">In addition to the column mapping for the **Person** entity type, the mapping of the insert, update, and delete functions of the **Person** type are shown.</span></span> <span data-ttu-id="dffd3-579">Le funzioni a cui viene eseguito il mapping vengono dichiarate nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-579">The functions that are mapped to are declared in the storage model.</span></span>
...
### <a name="example"></a><span data-ttu-id="dffd3-580">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-580">Example</span></span>

<span data-ttu-id="dffd3-581">Nell'esempio seguente viene illustrato il mapping del set di associazioni per il set di associazioni **CourseInstructor** nel modello School.</span><span class="sxs-lookup"><span data-stu-id="dffd3-581">The following example shows the association set mapping for the **CourseInstructor** association set in the School model.</span></span> <span data-ttu-id="dffd3-582">Oltre al mapping delle colonne per l'associazione **CourseInstructor** , viene visualizzato il mapping delle funzioni di inserimento ed eliminazione dell'associazione **CourseInstructor** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-582">In addition to the column mapping for the **CourseInstructor** association, the mapping of the insert and delete functions of the **CourseInstructor** association are shown.</span></span> <span data-ttu-id="dffd3-583">Le funzioni a cui viene eseguito il mapping vengono dichiarate nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-583">The functions that are mapped to are declared in the storage model.</span></span>
...
## <a name="queryview-element-msl"></a><span data-ttu-id="dffd3-584">Elemento QueryView (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-584">QueryView Element (MSL)</span></span>

<span data-ttu-id="dffd3-585">L'elemento **QueryView** in Mapping Specification Language (MSL) definisce un mapping di sola lettura tra un tipo di entità o un'associazione nel modello concettuale e una tabella nel database sottostante.</span><span class="sxs-lookup"><span data-stu-id="dffd3-585">The **QueryView** element in mapping specification language (MSL) defines a read-only mapping between an entity type or association in the conceptual model and a table in the underlying database.</span></span> <span data-ttu-id="dffd3-586">Il mapping viene definito con una query Entity SQL valutata rispetto al modello di archiviazione e il set di risultati viene espresso in termini di entità o associazione nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-586">The mapping is defined with an Entity SQL query that is evaluated against the storage model, and you express the result set in terms of an entity or association in the conceptual model.</span></span> <span data-ttu-id="dffd3-587">Poiché le visualizzazioni di query sono di sola lettura, non è possibile utilizzare comandi di aggiornamento standard per aggiornare i tipi definiti da tali visualizzazioni.</span><span class="sxs-lookup"><span data-stu-id="dffd3-587">Because query views are read-only, you cannot use standard update commands to update types that are defined by query views.</span></span> <span data-ttu-id="dffd3-588">A tale scopo è possibile utilizzare le funzioni di modifica.</span><span class="sxs-lookup"><span data-stu-id="dffd3-588">You can make updates to these types by using modification functions.</span></span> <span data-ttu-id="dffd3-589">Per altre informazioni, vedere Procedura: eseguire il mapping delle funzioni di modifica alle stored procedure.</span><span class="sxs-lookup"><span data-stu-id="dffd3-589">For more information, see How to: Map Modification Functions to Stored Procedures.</span></span>

> [!NOTE]
> <span data-ttu-id="dffd3-590">Nell'elemento **QueryView** , le espressioni Entity SQL che contengono **GroupBy**, aggregazioni di gruppo o proprietà di navigazione non sono supportate.</span><span class="sxs-lookup"><span data-stu-id="dffd3-590">In the **QueryView** element, Entity SQL expressions that contain **GroupBy**, group aggregates, or navigation properties are not supported.</span></span>

 

<span data-ttu-id="dffd3-591">L'elemento **QueryView** può essere un elemento figlio dell'elemento EntitySetMapping o AssociationSetMapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-591">The **QueryView** element can be a child of the EntitySetMapping element or the AssociationSetMapping element.</span></span> <span data-ttu-id="dffd3-592">Nel primo caso, la visualizzazione di query definisce un mapping di sola lettura per un'entità nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-592">In the former case, the query view defines a read-only mapping for an entity in the conceptual model.</span></span> <span data-ttu-id="dffd3-593">Nel secondo caso, la visualizzazione di query definisce un mapping di sola lettura per un'associazione nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-593">In the latter case, the query view defines a read-only mapping for an association in the conceptual model.</span></span>

> [!NOTE]
> <span data-ttu-id="dffd3-594">Se l'elemento **AssociationSetMapping** è per un'associazione con un vincolo referenziale, l'elemento **AssociationSetMapping** viene ignorato.</span><span class="sxs-lookup"><span data-stu-id="dffd3-594">If the **AssociationSetMapping** element is for an association with a referential constraint, the **AssociationSetMapping** element is ignored.</span></span> <span data-ttu-id="dffd3-595">Per ulteriori informazioni, vedere elemento ReferentialConstraint (CSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-595">For more information, see ReferentialConstraint Element (CSDL).</span></span>

<span data-ttu-id="dffd3-596">L'elemento **QueryView** non può contenere elementi figlio.</span><span class="sxs-lookup"><span data-stu-id="dffd3-596">The **QueryView** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-597">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-597">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-598">Nella tabella seguente vengono descritti gli attributi che è possibile applicare all'elemento **QueryView** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-598">The following table describes the attributes that can be applied to the **QueryView** element.</span></span>

| <span data-ttu-id="dffd3-599">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-599">Attribute Name</span></span> | <span data-ttu-id="dffd3-600">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-600">Is Required</span></span> | <span data-ttu-id="dffd3-601">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-601">Value</span></span>                                                                         |
|:---------------|:------------|:------------------------------------------------------------------------------|
| <span data-ttu-id="dffd3-602">**TypeName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-602">**TypeName**</span></span>   | <span data-ttu-id="dffd3-603">No</span><span class="sxs-lookup"><span data-stu-id="dffd3-603">No</span></span>          | <span data-ttu-id="dffd3-604">Nome del tipo di modello concettuale mappato dalla visualizzazione di query.</span><span class="sxs-lookup"><span data-stu-id="dffd3-604">The name of the conceptual model type that is being mapped by the query view.</span></span> |

### <a name="example"></a><span data-ttu-id="dffd3-605">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-605">Example</span></span>

<span data-ttu-id="dffd3-606">Nell'esempio seguente viene illustrato l'elemento **QueryView** come figlio dell'elemento **EntitySetMapping** e viene definito un mapping della visualizzazione di query per il tipo di entità **Department** nel modello School.</span><span class="sxs-lookup"><span data-stu-id="dffd3-606">The following example shows the **QueryView** element as a child of the **EntitySetMapping** element and defines a query view mapping for the **Department** entity type in the School Model.</span></span>
...
<span data-ttu-id="dffd3-607">Poiché la query restituisce solo un subset dei membri del tipo **Department** nel modello di archiviazione, il tipo **Department** del modello School è stato modificato in base a questo mapping come segue:</span><span class="sxs-lookup"><span data-stu-id="dffd3-607">Because the query only returns a subset of the members of the **Department** type in the storage model, the **Department** type in the School model has been modified based on this mapping as follows:</span></span>
...
### <a name="example"></a><span data-ttu-id="dffd3-608">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-608">Example</span></span>

<span data-ttu-id="dffd3-609">Nell'esempio seguente viene illustrato l'elemento **QueryView** come figlio di un elemento **AssociationSetMapping** e viene definito un mapping di sola lettura per l' `FK_Course_Department` associazione nel modello School.</span><span class="sxs-lookup"><span data-stu-id="dffd3-609">The next example shows the **QueryView** element as the child of an **AssociationSetMapping** element and defines a read-only mapping for the `FK_Course_Department` association in the School model.</span></span>
...
```
 
### <a name="comments"></a><span data-ttu-id="dffd3-610">Commenti</span><span class="sxs-lookup"><span data-stu-id="dffd3-610">Comments</span></span>

<span data-ttu-id="dffd3-611">È possibile definire le visualizzazioni di query per consentire gli scenari seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-611">You can define query views to enable the following scenarios:</span></span>

-   <span data-ttu-id="dffd3-612">Definire un'entità nel modello concettuale che non includa tutte le proprietà dell'entità nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-612">Define an entity in the conceptual model that doesn't include all the properties of the entity in the storage model.</span></span> <span data-ttu-id="dffd3-613">Sono incluse le proprietà che non dispongono di valori predefiniti e non supportano valori **null** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-613">This includes properties that do not have default values and do not support **null** values.</span></span>
-   <span data-ttu-id="dffd3-614">Eseguire il mapping delle colonne calcolate nel modello di archiviazione alle proprietà dei tipi di entità nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-614">Map computed columns in the storage model to properties of entity types in the conceptual model.</span></span>
-   <span data-ttu-id="dffd3-615">Definire un mapping in cui le condizioni utilizzate per partizionare le entità nel modello concettuale non siano basate sull'uguaglianza.</span><span class="sxs-lookup"><span data-stu-id="dffd3-615">Define a mapping where conditions used to partition entities in the conceptual model are not based on equality.</span></span> <span data-ttu-id="dffd3-616">Quando si specifica un mapping condizionale usando l'elemento **Condition** , la condizione fornita deve corrispondere al valore specificato.</span><span class="sxs-lookup"><span data-stu-id="dffd3-616">When you specify a conditional mapping using the **Condition** element, the supplied condition must equal the specified value.</span></span> <span data-ttu-id="dffd3-617">Per ulteriori informazioni, vedere elemento Condition (MSL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-617">For more information, see Condition Element (MSL).</span></span>
-   <span data-ttu-id="dffd3-618">Eseguire il mapping della stessa colonna nel modello di archiviazione a più tipi nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-618">Map the same column in the storage model to multiple types in the conceptual model.</span></span>
-   <span data-ttu-id="dffd3-619">Eseguire il mapping di più tipi alla stessa tabella.</span><span class="sxs-lookup"><span data-stu-id="dffd3-619">Map multiple types to the same table.</span></span>
-   <span data-ttu-id="dffd3-620">Definire associazioni nel modello concettuale che non siano basate sulle chiavi esterne dello schema relazionale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-620">Define associations in the conceptual model that are not based on foreign keys in the relational schema.</span></span>
-   <span data-ttu-id="dffd3-621">Utilizzare la logica di business personalizzata per impostare il valore delle proprietà nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-621">Use custom business logic to set the value of properties in the conceptual model.</span></span> <span data-ttu-id="dffd3-622">Ad esempio, è possibile eseguire il mapping del valore stringa "T" nell'origine dati a un valore **true**, un valore booleano, nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-622">For example, you could map the string value "T" in the data source to a value of **true**, a Boolean, in the conceptual model.</span></span>
-   <span data-ttu-id="dffd3-623">Definire filtri condizionali per i risultati della query.</span><span class="sxs-lookup"><span data-stu-id="dffd3-623">Define conditional filters for query results.</span></span>
-   <span data-ttu-id="dffd3-624">Applicare ai dati del modello concettuale un numero di restrizioni minore di quelle applicate al modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-624">Enforce fewer restrictions on data in the conceptual model than in the storage model.</span></span> <span data-ttu-id="dffd3-625">Ad esempio, è possibile creare una proprietà nel modello concettuale Nullable anche se la colonna a cui è stato eseguito il mapping non supporta valori **null**.</span><span class="sxs-lookup"><span data-stu-id="dffd3-625">For example, you could make a property in the conceptual model nullable even if the column to which it is mapped does not support **null**values.</span></span>

<span data-ttu-id="dffd3-626">Le considerazioni seguenti riguardano la definizione delle visualizzazioni di query per le entità:</span><span class="sxs-lookup"><span data-stu-id="dffd3-626">The following considerations apply when you define query views for entities:</span></span>

-   <span data-ttu-id="dffd3-627">Le visualizzazioni di query sono di sola lettura.</span><span class="sxs-lookup"><span data-stu-id="dffd3-627">Query views are read-only.</span></span> <span data-ttu-id="dffd3-628">È possibile applicare aggiornamenti alle entità solo utilizzando le funzioni di modifica.</span><span class="sxs-lookup"><span data-stu-id="dffd3-628">You can only make updates to entities by using modification functions.</span></span>
-   <span data-ttu-id="dffd3-629">Quando viene definito un tipo di entità da una visualizzazione di query, è necessario definire anche tutte le entità correlate dalle visualizzazioni di query.</span><span class="sxs-lookup"><span data-stu-id="dffd3-629">When you define an entity type by a query view, you must also define all related entities by query views.</span></span>
-   <span data-ttu-id="dffd3-630">Quando si esegue il mapping di un'associazione many-to-many a un'entità nel modello di archiviazione che rappresenta una tabella dei collegamenti nello schema relazionale, è necessario definire un elemento **QueryView** nell'elemento **AssociationSetMapping** per la tabella dei collegamenti.</span><span class="sxs-lookup"><span data-stu-id="dffd3-630">When you map a many-to-many association to an entity in the storage model that represents a link table in the relational schema, you must define a **QueryView** element in the **AssociationSetMapping** element for this link table.</span></span>
-   <span data-ttu-id="dffd3-631">È necessario definire le visualizzazioni di query per tutti i tipi di una gerarchia di tipi.</span><span class="sxs-lookup"><span data-stu-id="dffd3-631">Query views must be defined for all types in a type hierarchy.</span></span> <span data-ttu-id="dffd3-632">È possibile eseguire questa operazione nei modi seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-632">You can do this in the following ways:</span></span>
-   -   <span data-ttu-id="dffd3-633">Con un singolo elemento **QueryView** che specifica una singola query di Entity SQL che restituisce un'Unione di tutti i tipi di entità nella gerarchia.</span><span class="sxs-lookup"><span data-stu-id="dffd3-633">With a single **QueryView** element that specifies a single Entity SQL query that returns a union of all of the entity types in the hierarchy.</span></span>
    -   <span data-ttu-id="dffd3-634">Con un singolo elemento **QueryView** che specifica una singola query di Entity SQL che usa l'operatore case per restituire un tipo di entità specifico nella gerarchia in base a una condizione specifica.</span><span class="sxs-lookup"><span data-stu-id="dffd3-634">With a single **QueryView** element that specifies a single Entity SQL query that uses the CASE operator to return a specific entity type in the hierarchy based on a specific condition.</span></span>
    -   <span data-ttu-id="dffd3-635">Con un elemento **QueryView** aggiuntivo per un tipo specifico nella gerarchia.</span><span class="sxs-lookup"><span data-stu-id="dffd3-635">With an additional **QueryView** element for a specific type in the hierarchy.</span></span> <span data-ttu-id="dffd3-636">In questo caso, usare l'attributo **typeName** dell'elemento **QueryView** per specificare il tipo di entità per ogni visualizzazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-636">In this case, use the **TypeName** attribute of the **QueryView** element to specify the entity type for each view.</span></span>
-   <span data-ttu-id="dffd3-637">Quando viene definita una visualizzazione di query, non è possibile specificare l'attributo **StorageSetName** nell'elemento **EntitySetMapping** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-637">When a query view is defined, you cannot specify the **StorageSetName** attribute on the **EntitySetMapping** element.</span></span>
-   <span data-ttu-id="dffd3-638">Quando viene definita una visualizzazione di query, l'elemento **EntitySetMapping**non può contenere anche mapping di **Proprietà** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-638">When a query view is defined, the **EntitySetMapping**element cannot also contain **Property** mappings.</span></span>

## <a name="resultbinding-element-msl"></a><span data-ttu-id="dffd3-639">Elemento ResultBinding (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-639">ResultBinding Element (MSL)</span></span>

<span data-ttu-id="dffd3-640">L'elemento **risultante** in Mapping Specification Language (MSL) esegue il mapping dei valori di colonna restituiti dalle stored procedure alle proprietà dell'entità nel modello concettuale quando viene eseguito il mapping delle funzioni di modifica del tipo di entità alle stored procedure nel database sottostante.</span><span class="sxs-lookup"><span data-stu-id="dffd3-640">The **ResultBinding** element in mapping specification language (MSL) maps column values that are returned by stored procedures to entity properties in the conceptual model when entity type modification functions are mapped to stored procedures in the underlying database.</span></span> <span data-ttu-id="dffd3-641">Quando, ad esempio, il valore di una colonna Identity viene restituito da un stored procedure di inserimento, l'elemento **risultante** esegue il mapping del valore restituito a una proprietà del tipo di entità nel modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-641">For example, when the value of an identity column is returned by an insert stored procedure, the **ResultBinding** element maps the returned value to an entity type property in the conceptual model.</span></span>

<span data-ttu-id="dffd3-642">L'elemento **risultante** può essere figlio dell'elemento InsertFunction o dell'elemento UpdateFunction.</span><span class="sxs-lookup"><span data-stu-id="dffd3-642">The **ResultBinding** element can be child of the InsertFunction element or the UpdateFunction element.</span></span>

<span data-ttu-id="dffd3-643">L'elemento **risultante** non può contenere elementi figlio.</span><span class="sxs-lookup"><span data-stu-id="dffd3-643">The **ResultBinding** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-644">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-644">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-645">Nella tabella seguente vengono descritti gli attributi applicabili all'elemento **risultante** :</span><span class="sxs-lookup"><span data-stu-id="dffd3-645">The following table describes the attributes that are applicable to the **ResultBinding** element:</span></span>

| <span data-ttu-id="dffd3-646">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-646">Attribute Name</span></span> | <span data-ttu-id="dffd3-647">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-647">Is Required</span></span> | <span data-ttu-id="dffd3-648">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-648">Value</span></span>                                                                         |
|:---------------|:------------|:------------------------------------------------------------------------------|
| <span data-ttu-id="dffd3-649">**Nome**</span><span class="sxs-lookup"><span data-stu-id="dffd3-649">**Name**</span></span>       | <span data-ttu-id="dffd3-650">Sì</span><span class="sxs-lookup"><span data-stu-id="dffd3-650">Yes</span></span>         | <span data-ttu-id="dffd3-651">Nome della proprietà di entità nel modello concettuale di cui è in corso il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-651">The name of the entity property in the conceptual model that is being mapped.</span></span> |
| <span data-ttu-id="dffd3-652">**ColumnName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-652">**ColumnName**</span></span> | <span data-ttu-id="dffd3-653">Yes</span><span class="sxs-lookup"><span data-stu-id="dffd3-653">Yes</span></span>         | <span data-ttu-id="dffd3-654">Nome della colonna di cui viene eseguito il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-654">The name of the column being mapped.</span></span>                                          |

### <a name="example"></a><span data-ttu-id="dffd3-655">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-655">Example</span></span>

<span data-ttu-id="dffd3-656">L'esempio seguente è basato sul modello School e Mostra un elemento **InsertFunction** usato per eseguire il mapping della funzione di inserimento del tipo di entità **Person** alla stored procedure **InsertPerson** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-656">The following example is based on the School model and shows an **InsertFunction** element used to map the insert function of the **Person** entity type to the **InsertPerson** stored procedure.</span></span> <span data-ttu-id="dffd3-657">Il stored procedure **InsertPerson** è illustrato di seguito e viene dichiarato nel modello di archiviazione. Un elemento **risultante** viene utilizzato per eseguire il mapping di un valore di colonna restituito dal stored procedure (**NewPersonID**) a una proprietà del tipo di entità (**PersonID**).</span><span class="sxs-lookup"><span data-stu-id="dffd3-657">(The **InsertPerson** stored procedure is shown below and is declared in the storage model.) A **ResultBinding** element is used to map a column value that is returned by the stored procedure (**NewPersonID**) to an entity type property (**PersonID**).</span></span>
...
<span data-ttu-id="dffd3-658">L'istruzione Transact-SQL seguente descrive il stored procedure **InsertPerson** :</span><span class="sxs-lookup"><span data-stu-id="dffd3-658">The following Transact-SQL describes the **InsertPerson** stored procedure:</span></span>
...
## <a name="resultmapping-element-msl"></a><span data-ttu-id="dffd3-659">Elemento ResultMapping (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-659">ResultMapping Element (MSL)</span></span>

<span data-ttu-id="dffd3-660">L'elemento **ResultMapping** in Mapping Specification Language (MSL) definisce il mapping tra un'importazione di funzioni nel modello concettuale e una stored procedure nel database sottostante quando sono soddisfatte le condizioni seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-660">The **ResultMapping** element in mapping specification language (MSL) defines the mapping between a function import in the conceptual model and a stored procedure in the underlying database when the following are true:</span></span>

-   <span data-ttu-id="dffd3-661">L'operazione di importazione di funzioni restituisce un tipo di entità del modello concettuale.</span><span class="sxs-lookup"><span data-stu-id="dffd3-661">The function import returns a conceptual model entity type or complex type.</span></span>
-   <span data-ttu-id="dffd3-662">I nomi delle colonne restituite dalla stored procedure non corrispondono esattamente ai nomi delle proprietà del tipo di entità o del tipo complesso.</span><span class="sxs-lookup"><span data-stu-id="dffd3-662">The names of the columns returned by the stored procedure do not exactly match the names of the properties on the entity type or complex type.</span></span>

<span data-ttu-id="dffd3-663">Per impostazione predefinita, il mapping tra le colonne restituite da una stored procedure e un tipo di entità o un tipo complesso è basato sui nomi delle colonne e delle proprietà.</span><span class="sxs-lookup"><span data-stu-id="dffd3-663">By default, the mapping between the columns returned by a stored procedure and an entity type or complex type is based on column and property names.</span></span> <span data-ttu-id="dffd3-664">Se i nomi delle colonne non corrispondono esattamente ai nomi delle proprietà, è necessario utilizzare l'elemento **ResultMapping** per definire il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-664">If column names do not exactly match property names, you must use the **ResultMapping** element to define the mapping.</span></span> <span data-ttu-id="dffd3-665">Per un esempio del mapping predefinito, vedere elemento FunctionImportMapping (MSL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-665">For an example of the default mapping, see FunctionImportMapping Element (MSL).</span></span>

<span data-ttu-id="dffd3-666">L'elemento **ResultMapping** è un elemento figlio dell'elemento FunctionImportMapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-666">The **ResultMapping** element is a child element of the FunctionImportMapping element.</span></span>

<span data-ttu-id="dffd3-667">L'elemento **ResultMapping** può avere gli elementi figlio seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-667">The **ResultMapping** element can have the following child elements:</span></span>

-   <span data-ttu-id="dffd3-668">EntityTypeMapping (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-668">EntityTypeMapping (zero or more)</span></span>
-   <span data-ttu-id="dffd3-669">ComplexTypeMapping</span><span class="sxs-lookup"><span data-stu-id="dffd3-669">ComplexTypeMapping</span></span>

<span data-ttu-id="dffd3-670">Nessun attributo applicabile all'elemento **ResultMapping** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-670">No attributes are applicable to the **ResultMapping** Element.</span></span>

### <a name="example"></a><span data-ttu-id="dffd3-671">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-671">Example</span></span>

<span data-ttu-id="dffd3-672">Si consideri la stored procedure seguente:</span><span class="sxs-lookup"><span data-stu-id="dffd3-672">Consider the following stored procedure:</span></span>
...
<span data-ttu-id="dffd3-673">Si consideri inoltre il tipo di entità del modello concettuale seguente:</span><span class="sxs-lookup"><span data-stu-id="dffd3-673">Also consider the following conceptual model entity type:</span></span>
...
<span data-ttu-id="dffd3-674">Per creare un'importazione di funzioni che restituisce istanze del tipo di entità precedente, il mapping tra le colonne restituite dal stored procedure e il tipo di entità deve essere definito in un elemento **ResultMapping** :</span><span class="sxs-lookup"><span data-stu-id="dffd3-674">In order to create a function import that returns instances of the previous entity type, the mapping between the columns returned by the stored procedure and the entity type must be defined in a **ResultMapping** element:</span></span>
...
## <a name="scalarproperty-element-msl"></a><span data-ttu-id="dffd3-675">Elemento ScalarProperty (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-675">ScalarProperty Element (MSL)</span></span>

<span data-ttu-id="dffd3-676">L'elemento **ScalarProperty** in Mapping Specification Language (MSL) esegue il mapping di una proprietà su un tipo di entità del modello concettuale, un tipo complesso o un'associazione a una colonna della tabella o a un parametro di stored procedure nel database sottostante.</span><span class="sxs-lookup"><span data-stu-id="dffd3-676">The **ScalarProperty** element in mapping specification language (MSL) maps a property on a conceptual model entity type, complex type, or association to a table column or stored procedure parameter in the underlying database.</span></span>

> [!NOTE]
> <span data-ttu-id="dffd3-677">Le stored procedure a cui le funzioni di modifica sono mappate devono essere dichiarate nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-677">Stored procedures to which modification functions are mapped must be declared in the storage model.</span></span> <span data-ttu-id="dffd3-678">Per ulteriori informazioni, vedere elemento Function (SSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-678">For more information, see Function Element (SSDL).</span></span>

<span data-ttu-id="dffd3-679">L'elemento **ScalarProperty** può essere figlio dei seguenti elementi:</span><span class="sxs-lookup"><span data-stu-id="dffd3-679">The **ScalarProperty** element can be a child of the following elements:</span></span>

-   <span data-ttu-id="dffd3-680">MappingFragment</span><span class="sxs-lookup"><span data-stu-id="dffd3-680">MappingFragment</span></span>
-   <span data-ttu-id="dffd3-681">InsertFunction</span><span class="sxs-lookup"><span data-stu-id="dffd3-681">InsertFunction</span></span>
-   <span data-ttu-id="dffd3-682">UpdateFunction</span><span class="sxs-lookup"><span data-stu-id="dffd3-682">UpdateFunction</span></span>
-   <span data-ttu-id="dffd3-683">DeleteFunction</span><span class="sxs-lookup"><span data-stu-id="dffd3-683">DeleteFunction</span></span>
-   <span data-ttu-id="dffd3-684">EndProperty</span><span class="sxs-lookup"><span data-stu-id="dffd3-684">EndProperty</span></span>
-   <span data-ttu-id="dffd3-685">ComplexProperty</span><span class="sxs-lookup"><span data-stu-id="dffd3-685">ComplexProperty</span></span>
-   <span data-ttu-id="dffd3-686">ResultMapping</span><span class="sxs-lookup"><span data-stu-id="dffd3-686">ResultMapping</span></span>

<span data-ttu-id="dffd3-687">Come figlio dell'elemento **MappingFragment**, **ComplexProperty**o **EndProperty** , l'elemento **ScalarProperty** esegue il mapping di una proprietà nel modello concettuale a una colonna nel database.</span><span class="sxs-lookup"><span data-stu-id="dffd3-687">As a child of the **MappingFragment**, **ComplexProperty**, or **EndProperty** element, the **ScalarProperty** element maps a property in the conceptual model to a column in the database.</span></span> <span data-ttu-id="dffd3-688">Come figlio dell'elemento **InsertFunction**, **UpdateFunction**o **DeleteFunction** , l'elemento **ScalarProperty** esegue il mapping di una proprietà nel modello concettuale a un parametro stored procedure.</span><span class="sxs-lookup"><span data-stu-id="dffd3-688">As a child of the **InsertFunction**, **UpdateFunction**, or **DeleteFunction** element, the **ScalarProperty** element maps a property in the conceptual model to a stored procedure parameter.</span></span>

<span data-ttu-id="dffd3-689">L'elemento **ScalarProperty** non può contenere elementi figlio.</span><span class="sxs-lookup"><span data-stu-id="dffd3-689">The **ScalarProperty** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-690">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-690">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-691">Gli attributi che si applicano all'elemento **ScalarProperty** variano a seconda del ruolo dell'elemento.</span><span class="sxs-lookup"><span data-stu-id="dffd3-691">The attributes that apply to the **ScalarProperty** element differ depending on the role of the element.</span></span>

<span data-ttu-id="dffd3-692">Nella tabella seguente vengono descritti gli attributi applicabili quando si utilizza l'elemento **ScalarProperty** per eseguire il mapping di una proprietà del modello concettuale a una colonna nel database:</span><span class="sxs-lookup"><span data-stu-id="dffd3-692">The following table describes the attributes that are applicable when the **ScalarProperty** element is used to map a conceptual model property to a column in the database:</span></span>

| <span data-ttu-id="dffd3-693">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-693">Attribute Name</span></span> | <span data-ttu-id="dffd3-694">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-694">Is Required</span></span> | <span data-ttu-id="dffd3-695">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-695">Value</span></span>                                                           |
|:---------------|:------------|:----------------------------------------------------------------|
| <span data-ttu-id="dffd3-696">**Nome**</span><span class="sxs-lookup"><span data-stu-id="dffd3-696">**Name**</span></span>       | <span data-ttu-id="dffd3-697">Sì</span><span class="sxs-lookup"><span data-stu-id="dffd3-697">Yes</span></span>         | <span data-ttu-id="dffd3-698">Nome della proprietà del modello concettuale di cui è in corso il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-698">The name of the conceptual model property that is being mapped.</span></span> |
| <span data-ttu-id="dffd3-699">**ColumnName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-699">**ColumnName**</span></span> | <span data-ttu-id="dffd3-700">Sì</span><span class="sxs-lookup"><span data-stu-id="dffd3-700">Yes</span></span>         | <span data-ttu-id="dffd3-701">Nome della colonna della tabella di cui è in corso il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-701">The name of the table column that is being mapped.</span></span>              |

<span data-ttu-id="dffd3-702">Nella tabella seguente vengono descritti gli attributi applicabili all'elemento **ScalarProperty** quando viene utilizzato per eseguire il mapping di una proprietà del modello concettuale a un parametro stored procedure:</span><span class="sxs-lookup"><span data-stu-id="dffd3-702">The following table describes the attributes that are applicable to the **ScalarProperty** element when it is used to map a conceptual model property to a stored procedure parameter:</span></span>

| <span data-ttu-id="dffd3-703">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-703">Attribute Name</span></span>    | <span data-ttu-id="dffd3-704">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-704">Is Required</span></span> | <span data-ttu-id="dffd3-705">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-705">Value</span></span>                                                                                                                                           |
|:------------------|:------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="dffd3-706">**Nome**</span><span class="sxs-lookup"><span data-stu-id="dffd3-706">**Name**</span></span>          | <span data-ttu-id="dffd3-707">Sì</span><span class="sxs-lookup"><span data-stu-id="dffd3-707">Yes</span></span>         | <span data-ttu-id="dffd3-708">Nome della proprietà del modello concettuale di cui è in corso il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-708">The name of the conceptual model property that is being mapped.</span></span>                                                                                 |
| <span data-ttu-id="dffd3-709">**ParameterName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-709">**ParameterName**</span></span> | <span data-ttu-id="dffd3-710">Sì</span><span class="sxs-lookup"><span data-stu-id="dffd3-710">Yes</span></span>         | <span data-ttu-id="dffd3-711">Nome del parametro di cui è in corso il mapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-711">The name of the parameter that is being mapped.</span></span>                                                                                                 |
| <span data-ttu-id="dffd3-712">**Version**</span><span class="sxs-lookup"><span data-stu-id="dffd3-712">**Version**</span></span>       | <span data-ttu-id="dffd3-713">No</span><span class="sxs-lookup"><span data-stu-id="dffd3-713">No</span></span>          | <span data-ttu-id="dffd3-714">**Corrente** o **originale** a seconda che il valore corrente o il valore originale della proprietà debba essere usato per i controlli di concorrenza.</span><span class="sxs-lookup"><span data-stu-id="dffd3-714">**Current** or **Original** depending on whether the current value or the original value of the property should be used for concurrency checks.</span></span> |

### <a name="example"></a><span data-ttu-id="dffd3-715">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-715">Example</span></span>

<span data-ttu-id="dffd3-716">Nell'esempio seguente viene illustrato l'elemento **ScalarProperty** usato in due modi:</span><span class="sxs-lookup"><span data-stu-id="dffd3-716">The following example shows the **ScalarProperty** element used in two ways:</span></span>

-   <span data-ttu-id="dffd3-717">Per eseguire il mapping delle proprietà del tipo di entità **Person** alle colonne della tabella **Person**.</span><span class="sxs-lookup"><span data-stu-id="dffd3-717">To map the properties of the **Person** entity type to the columns of the **Person**table.</span></span>
-   <span data-ttu-id="dffd3-718">Per eseguire il mapping delle proprietà del tipo di entità **Person** ai parametri del stored procedure **UpdatePerson** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-718">To map the properties of the **Person** entity type to the parameters of the **UpdatePerson** stored procedure.</span></span> <span data-ttu-id="dffd3-719">Le stored procedure vengono dichiarate nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-719">The stored procedures are declared in the storage model.</span></span>
...
### <a name="example"></a><span data-ttu-id="dffd3-720">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-720">Example</span></span>

<span data-ttu-id="dffd3-721">Nell'esempio seguente viene illustrato l'elemento **ScalarProperty** utilizzato per eseguire il mapping delle funzioni Insert e Delete di un'associazione del modello concettuale alle stored procedure nel database.</span><span class="sxs-lookup"><span data-stu-id="dffd3-721">The next example shows the **ScalarProperty** element used to map the insert and delete functions of a conceptual model association to stored procedures in the database.</span></span> <span data-ttu-id="dffd3-722">Le stored procedure vengono dichiarate nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-722">The stored procedures are declared in the storage model.</span></span>
...
## <a name="updatefunction-element-msl"></a><span data-ttu-id="dffd3-723">Elemento UpdateFunction (MSL)</span><span class="sxs-lookup"><span data-stu-id="dffd3-723">UpdateFunction Element (MSL)</span></span>

<span data-ttu-id="dffd3-724">L'elemento **UpdateFunction** in Mapping Specification Language (MSL) esegue il mapping della funzione di aggiornamento di un tipo di entità nel modello concettuale a una stored procedure nel database sottostante.</span><span class="sxs-lookup"><span data-stu-id="dffd3-724">The **UpdateFunction** element in mapping specification language (MSL) maps the update function of an entity type in the conceptual model to a stored procedure in the underlying database.</span></span> <span data-ttu-id="dffd3-725">Le stored procedure a cui le funzioni di modifica sono mappate devono essere dichiarate nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-725">Stored procedures to which modification functions are mapped must be declared in the storage model.</span></span> <span data-ttu-id="dffd3-726">Per ulteriori informazioni, vedere elemento Function (SSDL).</span><span class="sxs-lookup"><span data-stu-id="dffd3-726">For more information, see Function Element (SSDL).</span></span>

> [!NOTE]
>  <span data-ttu-id="dffd3-727">Se non si esegue il mapping di tutte e tre le operazioni di inserimento, aggiornamento o eliminazione di un tipo di entità alle stored procedure, le operazioni non mappate avranno esito negativo se eseguite in fase di esecuzione e viene generata un'eccezione UpdateException.</span><span class="sxs-lookup"><span data-stu-id="dffd3-727">If you do not map all three of the insert, update, or delete operations of a entity type to stored procedures, the unmapped operations will fail if executed at runtime and an UpdateException is thrown.</span></span>

<span data-ttu-id="dffd3-728">L'elemento **UpdateFunction** può essere un elemento figlio dell'elemento ModificationFunctionMapping e applicato all'elemento EntityTypeMapping.</span><span class="sxs-lookup"><span data-stu-id="dffd3-728">The **UpdateFunction** element can be a child of the ModificationFunctionMapping element and applied to the EntityTypeMapping element.</span></span>

<span data-ttu-id="dffd3-729">L'elemento **UpdateFunction** può avere gli elementi figlio seguenti:</span><span class="sxs-lookup"><span data-stu-id="dffd3-729">The **UpdateFunction** element can have the following child elements:</span></span>

-   <span data-ttu-id="dffd3-730">AssociationEnd (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-730">AssociationEnd (zero or more)</span></span>
-   <span data-ttu-id="dffd3-731">ComplexProperty (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-731">ComplexProperty (zero or more)</span></span>
-   <span data-ttu-id="dffd3-732">ResultBinding (zero o un elemento)</span><span class="sxs-lookup"><span data-stu-id="dffd3-732">ResultBinding (zero or one)</span></span>
-   <span data-ttu-id="dffd3-733">ScarlarProperty (zero o più elementi)</span><span class="sxs-lookup"><span data-stu-id="dffd3-733">ScarlarProperty (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="dffd3-734">Attributi applicabili</span><span class="sxs-lookup"><span data-stu-id="dffd3-734">Applicable Attributes</span></span>

<span data-ttu-id="dffd3-735">Nella tabella seguente vengono descritti gli attributi che è possibile applicare all'elemento **UpdateFunction** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-735">The following table describes the attributes that can be applied to the **UpdateFunction** element.</span></span>

| <span data-ttu-id="dffd3-736">Nome attributo</span><span class="sxs-lookup"><span data-stu-id="dffd3-736">Attribute Name</span></span>            | <span data-ttu-id="dffd3-737">Obbligatorio</span><span class="sxs-lookup"><span data-stu-id="dffd3-737">Is Required</span></span> | <span data-ttu-id="dffd3-738">Valore</span><span class="sxs-lookup"><span data-stu-id="dffd3-738">Value</span></span>                                                                                                                                                    |
|:--------------------------|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="dffd3-739">**FunctionName**</span><span class="sxs-lookup"><span data-stu-id="dffd3-739">**FunctionName**</span></span>          | <span data-ttu-id="dffd3-740">Yes</span><span class="sxs-lookup"><span data-stu-id="dffd3-740">Yes</span></span>         | <span data-ttu-id="dffd3-741">Nome completo dello spazio dei nomi della stored procedure a cui la funzione di aggiornamento viene mappata.</span><span class="sxs-lookup"><span data-stu-id="dffd3-741">The namespace-qualified name of the stored procedure to which the update function is mapped.</span></span> <span data-ttu-id="dffd3-742">La stored procedure deve essere dichiarata nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-742">The stored procedure must be declared in the storage model.</span></span> |
| <span data-ttu-id="dffd3-743">**RowsAffectedParameter**</span><span class="sxs-lookup"><span data-stu-id="dffd3-743">**RowsAffectedParameter**</span></span> | <span data-ttu-id="dffd3-744">No</span><span class="sxs-lookup"><span data-stu-id="dffd3-744">No</span></span>          | <span data-ttu-id="dffd3-745">Nome del parametro di output che restituisce il numero di righe interessate.</span><span class="sxs-lookup"><span data-stu-id="dffd3-745">The name of the output parameter that returns the number of rows affected.</span></span>                                                                               |

### <a name="example"></a><span data-ttu-id="dffd3-746">Esempio</span><span class="sxs-lookup"><span data-stu-id="dffd3-746">Example</span></span>

<span data-ttu-id="dffd3-747">L'esempio seguente è basato sul modello School e Mostra l'elemento **UpdateFunction** usato per eseguire il mapping della funzione di aggiornamento del tipo di entità **Person** alla stored procedure **UpdatePerson** .</span><span class="sxs-lookup"><span data-stu-id="dffd3-747">The following example is based on the School model and shows the **UpdateFunction** element used to map update function of the **Person** entity type to the **UpdatePerson** stored procedure.</span></span> <span data-ttu-id="dffd3-748">Il stored procedure **UpdatePerson** viene dichiarato nel modello di archiviazione.</span><span class="sxs-lookup"><span data-stu-id="dffd3-748">The **UpdatePerson** stored procedure is declared in the storage model.</span></span>
