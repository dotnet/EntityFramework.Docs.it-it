...
## <a name="column-comments"></a>Commenti colonna

È possibile impostare un commento di testo arbitrario che viene impostato nella colonna del database, consentendo di documentare lo schema nel database:
