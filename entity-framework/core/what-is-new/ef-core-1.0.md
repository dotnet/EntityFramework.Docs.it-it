...
Sono disponibili diversi provider per gli altri motori di database. Per un elenco completo, vedere [Database Providers](xref:core/providers/index) (Provider di database).
