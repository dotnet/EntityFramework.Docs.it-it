...
Si noti che molte delle [modifiche di rilievo a livello di applicazione](xref:core/what-is-new/ef-core-3.0/breaking-changes) influiscano anche sui provider.
