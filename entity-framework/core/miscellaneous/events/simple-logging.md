...
> [!TIP]  
> È possibile [visualizzare e scaricare l'esempio di questo articolo](https://github.com/dotnet/EntityFramework.Docs/tree/master/samples/core/Miscellaneous/SimpleLogging) in GitHub.
...
> [!TIP]
> EF Core si integra anche con [Microsoft. Extensions. Logging](/aspnet/core/fundamentals/logging), che richiede una maggiore configurazione, ma è spesso più adatto per la registrazione nelle applicazioni di produzione.
