...
## <a name="1-create-an-existing-database"></a><span data-ttu-id="9f850-113">1. creare un database esistente</span><span class="sxs-lookup"><span data-stu-id="9f850-113">1. Create an Existing Database</span></span>
